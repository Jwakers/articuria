    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          >
            <path d="M21 15V6m0 0H3m18 0-6.5 6.5a1 1 0 0 1-1.4 0L9.5 9m11.5-3-4-4m4 4-4 4" />
          </svg>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Favorite Topic</CardTitle>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="none"
